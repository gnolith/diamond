...
| Secure read-only default; explicit update and federation opt-in                                     | Proven                                    | endpoint tests plus `docs/threat-model.md`                                                                                                        |
...
| Independent developer integration                                                                   | Pending human evidence                    | the exact clean-room procedure exists in `docs/integration-validation.md`, but its second-person sign-off is intentionally not self-certified     |
| Final public-release review and governance                                                          | Pending decisions                         | repository visibility, branch protection/account plan, second maintainer or accepted bus-factor risk, npm trusted publisher, and `0.1.0` are open |
