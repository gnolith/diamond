...
| Independent clean-room integration                                                                  | Pending external evidence                 | the exact procedure exists in `docs/integration-validation.md`; an independent person or context-free agent must produce the sign-off       |
