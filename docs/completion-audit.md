...
| Independent clean-room integration                                                                  | Two failed candidates; rerun required     | `c64e32b` failed Worker XML/probe packaging; `4a0e008` passed behavior but lacked an executable managed-catalog check; see `docs/deployed-e2e.md` |
